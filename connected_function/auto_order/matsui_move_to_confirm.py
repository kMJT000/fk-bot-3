...
PATH_IMG_MATSUI = '/home/pi/Documents/raspberrypi/connected_function/images/'
...
# 注文するボタンをクリック（取り扱い注意！）
def auto_operation_order():
    IMG_ORDER_BUTTON = PATH_IMG_MATSUI + 'order_button.png'

    position_x, position_y = pyautogui.locateCenterOnScreen(IMG_ORDER_BUTTON)
    pyautogui.click(position_x, position_y)
